...
export class MemStorage implements IStorage {
  ...
  private initializeSampleData() {
    ...
    const defaultSkills: Skill[] = [
      ...
      { id: 4, category: "Mobile", name: "React Native", level: "Intermediate", percentage: 65 },
      { id: 5, category: "Mobile", name: "Kotlin", level: "Intermediate", percentage: 60 },
      ...
      { id: 9, category: "Backend", name: "Node.js", level: "Intermediate", percentage: 75 },
      { id: 10, category: "Backend", name: "API Integration", level: "Expert", percentage: 90 },
      { id: 11, category: "Backend", name: "MongoDB", level: "Intermediate", percentage: 65 },
      { id: 12, category: "Backend", name: "PostgreSQL", level: "Intermediate", percentage: 65 },
      { id: 13, category: "Game Dev", name: "Flame Engine", level: "Beginner", percentage: 40 },
      { id: 14, category: "AI/ML", name: "AI Model Training", level: "Intermediate", percentage: 70 },
      { id: 15, category: "Frontend", name: "React", level: "Intermediate", percentage: 70 },
      { id: 16, category: "Frontend", name: "JavaScript", level: "Advanced", percentage: 85 },
      { id: 17, category: "Frontend", name: "TypeScript", level: "Intermediate", percentage: 75 },
      { id: 18, category: "Frontend", name: "HTML/CSS", level: "Advanced", percentage: 90 },
      { id: 19, category: "Tools", name: "Git & VS Code", level: "Expert", percentage: 95 },
      { id: 20, category: "Tools", name: "Docker", level: "Beginner", percentage: 45 },
      { id: 21, category: "Tools", name: "Figma", level: "Intermediate", percentage: 65 },
      { id: 22, category: "Skills", name: "Problem Solving", level: "Expert", percentage: 95 },
      { id: 23, category: "Skills", name: "Communication", level: "Advanced", percentage: 85 },
    ];
    defaultSkills.forEach(skill => this.skills.set(skill.id, skill));
    this.currentSkillId = 24;
